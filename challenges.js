...
var retweet = tweeter.replace("maps", "naps");
...
function isPalindrome(word){
	return (word.split("").reverse(word).join("")) === (word);
}
...
function letterCount(phrase){
    var letters = (phrase.split("")).match(/a/b/d/e/f/g/h/i/j/k/l/m/n/o/p/q/r/s/t/u/v/w/x/y/z).length; // Need to split the word up into a string with separate letters
    // Then find a way to compare the letters to see how many there are of each
	 //return an object that lists the letters and how many there are of them
